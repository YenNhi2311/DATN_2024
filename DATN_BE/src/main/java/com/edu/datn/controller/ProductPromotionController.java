...
public class ProductPromotionController {
  ...
  public ResponseEntity<ProductPromotionDTO> createProductPromotion(
    ...
    ProductPromotionDTO createdProductPromotion = productPromotionService
        .createProductPromotion(productPromotionDTO);
    return ResponseEntity.ok(createdProductPromotion);
  }

  @PutMapping("/{id}")
  public ResponseEntity<ProductPromotionDTO> updateProductPromotion(@PathVariable Integer id,
      @RequestBody ProductPromotionDTO productPromotionDTO) {
    ProductPromotionDTO updatedProductPromotion = productPromotionService.updateProductPromotion(id,
        productPromotionDTO);
