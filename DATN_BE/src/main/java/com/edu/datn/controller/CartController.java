...
public class CartController {
  ...
  public ResponseEntity<List<CartItemDTO>> getCartItemsByUserId(
    ...
    try {
      ...
      List<CartItemEntity> cartItems = cartItemService.findAllItemsByCartId(
        carts.get(0).getCartId()
      );
      ...
      for (CartItemEntity cartItem : cartItems) {
        ...
        if (productDetail != null) {
          ...
          if (
            productPromotion != null && productPromotion.getPromotion() != null
          ) {
            LocalDateTime endDate = productPromotion
              .getPromotion()
              .getEndDate();
            ...
            if (endDate.isBefore(currentDate)) {
              ...
              double discountPercent = productPromotion
                .getPromotion()
                .getPercent();
  ...
  public ResponseEntity<CartItemEntity> addCartItem(
    ...
    try {
      ...
      ProductDetailsEntity productDetail = productDetailsService.findById(
        productDetailId
      );
      if (productDetail == null) {
        return ResponseEntity.status(HttpStatus.NOT_FOUND).build();
      ...
      if (productPromotionId != 0) {
        productPromotion =
          productPromotionService.getProductPromotionById(productPromotionId);
        if (productPromotion == null) {
          productPromotion = null;
        }
      }

      CartItemEntity existingCartItem = cartItemService.findByCartIdAndProductDetailIdAndProductPromotionId(
        cartId,
        productDetailId,
        productPromotionId
      );
      ...
      if (existingCartItem != null) {
        ...
        CartItemEntity updatedCartItem = cartItemService.saveCartItem(
          existingCartItem
        );
