...
public class ProductDetailsController {
  ...
  public ResponseEntity<List<ProductDetailsDTO>> getProductDetails(
    ...
    List<ProductDetailsDTO> productDetails = productDetailsService.getProductDetailsByProductId(
      productId
    );
  ...
  public ResponseEntity<ProductDetailsDTO> createProductDetails(
    ...
    ProductDetailsDTO savedProductDetails = productDetailsService.createProductDetails(
      productDetailsDTO,
      imgFile
    );
  ...
  public ResponseEntity<ProductDetailsDTO> updateProductDetails(
    ...
    throws IOException {
    ProductDetailsDTO existingProductDetails = productDetailsService.getProductDetailsById(
      id
    );
    ...
    try {
      ProductDetailsDTO updatedProductDetails = productDetailsService.updateProductDetails(
        id,
        productDetailsDTO,
        imgFile
      );
