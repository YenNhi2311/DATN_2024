...
public class HomeController {
  ...
  public ResponseEntity<ProductPromotionDTO> getProductPromotionById(
    ...
    return ResponseEntity.ok(
      productPromotionService.getProductPromotionById(id)
    );
  }
  ...
  public ResponseEntity<List<ProductDetailsDTO>> getProductDetailsByProductId(
  ...
  @GetMapping("/capacity")
  public ResponseEntity<CapacitiesDTO> getCapacityById(
    @RequestParam Integer id
  ) {
