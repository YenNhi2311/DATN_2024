...
public class ProductDetailsService {
  ...
  private ProductDetailsDTO toDTO(ProductDetailsEntity productDetails) {
    ...
    dto.setColorId(
      productDetails.getColor() != null
        ? productDetails.getColor().getColorId()
        : null
    );
    dto.setSkintypeId(
      productDetails.getSkintype() != null
        ? productDetails.getSkintype().getSkintypeId()
        : null
    );
    dto.setCapacityId(
      productDetails.getCapacity() != null
        ? productDetails.getCapacity().getCapacityId()
        : null
    );
    dto.setIngredientId(
      productDetails.getIngredient() != null
        ? productDetails.getIngredient().getIngredientId()
        : null
    );
    dto.setBenefitId(
      productDetails.getBenefit() != null
        ? productDetails.getBenefit().getBenefitId()
        : null
    );
    return dto;
  }
