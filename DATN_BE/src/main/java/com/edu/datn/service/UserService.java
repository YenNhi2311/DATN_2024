...
public class UserService {
  ...
  public void updateUser(UserDTO userDTO, MultipartFile img)
    throws IOException {
    Optional<UserEntity> existingUserOptional = userJPA.findById(
      userDTO.getUserId()
    );
  ...
  public void updateUserPass(ChangePasswordRequest changePasswordRequest) {
    ...
    Optional<UserEntity> existingUserOptional = userJPA.findById(
      Integer.parseInt(changePasswordRequest.getUserId())
    );
