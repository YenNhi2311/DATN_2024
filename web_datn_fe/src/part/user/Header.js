...
const Header = () => {
    ...
    const handleShopNavigation = () => {
        // Xóa selectedCategoryId và selectedBrandId khỏi localStorage
        ...
        if (location.pathname.startsWith("/social")) {
            return (
                <>
                    ...
                    <Link
                        ...
                        className={`nav-item nav-link ${location.pathname === "/social/notifications" ? "active" : ""
                            }`}
                        style={{
                            color:
            ...
            return (
                <div className="navbar-nav mx-auto">
                    ...
                    <Link
                        to="/address"
                        className={`nav-item nav-link ${location.pathname === "/address" ? "active" : ""
                            }`}
                        style={{
                            color: location.pathname === "/address" ? "#2575fc" : "#000",
                            fontWeight: location.pathname === "/address" ? "bold" : "normal",
                            borderBottom:
                                location.pathname === "/address" ? "2px solid #2575fc" : "none",
                        }}
                    >
                        Địa Chỉ
                    </Link>
