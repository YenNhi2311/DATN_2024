...
export const updateCartItem = async (cartItemId, productDetailId, productPromotionId, quantity) => {
  try {
...
//thêm vào giỏ hàng 
export const addToCart = async (cartId, productDetailId, productPromotionId, quantity) => {
  try {
    const response = await apiClient.post(
...
export const getPromotionById = async (promotionId) => {
  try {
    const response = await apiClient.get(`api/home/promotion?id=${promotionId}`);
...
export const getProductDetailById = async (productId) => {
  try {
    const response = await apiClient.get(`api/home/productdetail?productId=${productId}`);
...
export const getIngredientById = async (ingredientId) => {
  try {
    const response = await apiClient.get(`api/home/ingredient?id=${ingredientId}`);
