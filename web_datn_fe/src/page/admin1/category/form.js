...
const FormCategory = ({ onClose, editData }) => {
    // Khởi tạo state formData để lưu trữ thông tin form (categoryId và name)
    ...
    useEffect(() => {
        if (editData) {
            ...
            setFormData({ categoryId: editData.categoryId, name: editData.name });
    ...
    const handleSubmit = async (e) => {
        ...
        if (isUpdating && (!formData.categoryId || isNaN(formData.categoryId))) {
