  ...
  const handleAddToCart = async (productDetailId, productPromotionId, quantity = 1) => {
    ...
    try {
      ...
      if (existingCartItem) {
        ...
        await updateCartItem(existingCartItem.cartItemId, productDetailId, productPromotionId, updatedQuantity);
                  ...
                  <div className="pro-container">
                    <div className="pro">
                      <a onClick={() => handleViewProduct(item.product.productId)}>
                        <img src={require(`../../assets/img/${item.productDetails?.img || "default.jpg"}`)} alt={item.product.name} />
                      </a>
                      <div className="icon-container">
                        <a className="btn" onClick={() => handleAddToCart(item.productDetails.productDetailId, item.productDetails.productPromotionId || 0, 1)}>
                      ...
                      <div className="des">
                        ...
                        <div className="price">
                          <h4 className="sale-price">{item.productDetails.price.toLocaleString()} đ</h4>
                        </div>
